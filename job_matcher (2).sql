...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2013 at 06:06 PM
...
--
CREATE DATABASE IF NOT EXISTS `job_matcher` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `job_matcher`;
